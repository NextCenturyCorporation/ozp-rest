...
DEFAULT_OUTPUT_FILE_BASENAME="ozp-rest-01CenterSettingsAPIs"
DEFAULT_OUTPUT_FORMAT="pdf"
DEFAULT_OUTPUT_DIR=.


ORDERED_SOURCE_LIST="rest/CenterSettingsAPIs/OZP_agencyAPI.md \
					 rest/CenterSettingsAPIs/OZP_categoryAPI.md \
					 rest/CenterSettingsAPIs/OZP_contactTypeAPI.md"
