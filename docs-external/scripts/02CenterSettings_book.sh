...
DEFAULT_OUTPUT_FILE_BASENAME="ozp-rest-02CenterSettingsAPIs"
DEFAULT_OUTPUT_FORMAT="pdf"
DEFAULT_OUTPUT_DIR=.


ORDERED_SOURCE_LIST="rest/CenterSettingsAPIs/OZP_imageAPI.md \
					 rest/CenterSettingsAPIs/OZP_intentAPI.md
					 rest/CenterSettingsAPIs/OZP_notification.md"
