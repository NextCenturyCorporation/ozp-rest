...
DEFAULT_OUTPUT_FILE_BASENAME="ozp-rest-03CenterSettingsAPIs"
DEFAULT_OUTPUT_FORMAT="pdf"
DEFAULT_OUTPUT_DIR=.


ORDERED_SOURCE_LIST="rest/CenterSettingsAPIs/OZP_profileAPI.md \
					 rest/CenterSettingsAPIs/OZP_scorecardAPI.md \
					 rest/CenterSettingsAPIs/OZP_typeAPI.md"
