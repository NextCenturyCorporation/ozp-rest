...
DEFAULT_OUTPUT_FILE_BASENAME="ozp-rest"
DEFAULT_OUTPUT_FORMAT="pdf"
DEFAULT_OUTPUT_DIR=.


ORDERED_SOURCE_LIST="rest/LegacyAPIs/deleteUserPreference.md \
					 rest/LegacyAPIs/doesUserPreferenceExist.md \
					 rest/LegacyAPIs/findWidget.md \
					 rest/LegacyAPIs/getUserPreference.md \
					 rest/LegacyAPIs/getWidget.md \
					 rest/OZP_agencyAPI.md \
					 rest/OZP_applicationLibraryEntryAPI.md \
					 rest/OZP_categoryAPI.md \
					 rest/OZP_contactTypeAPI.md \
					 rest/OZP_dataAPI.md \
					 rest/OZP_imageAPI.md \
					 rest/OZP_intentAPI.md \
					 rest/OZP_listing_createAPI.md"
