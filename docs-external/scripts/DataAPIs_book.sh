...
DEFAULT_OUTPUT_FILE_BASENAME="ozp-dataAPIs"
DEFAULT_OUTPUT_FORMAT="pdf"
DEFAULT_OUTPUT_DIR=.


ORDERED_SOURCE_LIST="rest/DataAPIs/OZP_applicationLibraryEntryAPI.md \
					 rest/DataAPIs/OZP_dataAPI.md \
					 rest/DataAPIs/OZP_metadataAPI.md \
					 rest/DataAPIs/OZP_searchAPI.md \
					 rest/DataAPIs/OZP_storefrontAPI.md"
